...
// import org.firstinspires.ftc.teamcode.autonomous.AutoRoute;
 ...
 public class GenericDetector implements Runnable{
     ...
     private String modelFileName = "blue.tflite";//"croppedRingRec.tflite";
     private String labelFileName = "labels.txt";//"croppedLabels.txt";
     private static Classifier.Model MODEl_TYPE = Classifier.Model.FLOAT_EFFICIENTNET;
     private static final String LABEL_L = "l";
     private static final String LABEL_C = "c";
     private static final String LABEL_R = "r";

     private String result = LABEL_C; //just a default value.
                 ...
                 if (results == null || results.size() == 0) {
                     ...
                     for (Classifier.Recognition r : results) {
                         if (r.getConfidence() >= 0.8) {
                             ...
                             if (r.getTitle().contains(LABEL_R)) {
                                 this.result = LABEL_R;
                             }
                             else if(r.getTitle().contains(LABEL_C)){
                                 this.result = LABEL_C;
                             }
                             else if(r.getTitle().contains(LABEL_L)){
                                 this.result = LABEL_L;
                             }
                         }
                     }
